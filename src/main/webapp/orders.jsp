...
function sendorder(){
	...
	var address_id=0;
	 ...
	 $.ajax({
		    url: "sendorder",
	        type: "POST",
	        data: {user_id:user_id,address_id:address_id,assessstatus:assessstatus,comments:comments,status:status,ids:ids,nowamount:nowamount,amount:amount},
										...
										<c:forEach items="${requestScope.orderslist}" var="o">
											<dd class="item clearfix">
												<div class="item-row">
													...
													<div class="col col-3">${o.scount}</div>
													<div class="col col-4">${o.nowprice*o.scount}</div>
												</div>
											</dd>
										</c:forEach>
									...
									<div class="checkout-count clearfix">
										...
										<div class="checkout-price">
											<p class="checkout-total">
												应付总额：<span><strong id="totalPrice" class="allcount">${allcount}</strong>元</span>
											</p>
										</div>
										<!--  -->
									</div>
